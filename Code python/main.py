...
class Analyse_donnees :
    ...
    def write_concordance_prod_in_circuit(self, filename) :
        ...
        """
        print(self.mat_concordance_prod_in_circuit)
...
def main(warehouse_dir):
    ...
    # analyse.get_concordance_produits_meme_famille()

    # print("\n Concordance des produits même famille : \n")
    # for i in range(len(analyse.mat_concordance_prod_in_circuit)) :
    #     print('id :', i, end=" : ")
    #     for j in range(len(analyse.mat_concordance_prod_in_circuit)) :
    #         if analyse.mat_concordance_prod_in_circuit[i][j] > 0 and i != j:
    #             print(j, "(",analyse.mat_concordance_prod_in_circuit[i][j],") ", end="")
    #     print()


    #print("\n Concordance des produits même famille : \n")
    #print(analyse.mat_concordance_produit)

    #analyse.write_freq_prod(os.path.join(ROOT_DIR, "freq_prod_toy_instance.txt"))
    #analyse.write_freq_prod(os.path.join(ROOT_DIR, "freq_prod_big_category.txt"))
    #analyse.write_freq_prod(os.path.join(ROOT_DIR, "freq_prod_big_market.txt"))
    analyse.write_freq_prod(os.path.join(ROOT_DIR, "freq_prod_big_family.txt"))

    #analyse.write_concordance_prod_in_circuit(os.path.join(ROOT_DIR, "concord_prod_same_circuit_toy.txt"))
    #analyse.write_concordance_prod_in_circuit(os.path.join(ROOT_DIR, "concord_prod_same_circuit_market.txt"))
    #analyse.write_concordance_prod_in_circuit(os.path.join(ROOT_DIR, "concord_prod_same_circuit_family.txt"))
    #analyse.write_concordance_prod_in_circuit(os.path.join(ROOT_DIR, "concord_prod_same_circuit_category.txt"))
        
    #analyse.write_freq_circuit(os.path.join(ROOT_DIR, "freq_circuit_toy_instance.txt"))
    #analyse.write_freq_circuit(os.path.join(ROOT_DIR, "freq_circuit_big_category.txt"))
    #analyse.write_freq_circuit(os.path.join(ROOT_DIR, "freq_circuit_big_market.txt"))
    #analyse.write_freq_circuit(os.path.join(ROOT_DIR, "freq_circuit_big_family.txt"))
...
if __name__ == "__main__":
    print(ROOT_DIR)
    #main(os.path.join(ROOT_DIR, "warehouses", "warehouse_toy"))
    #main(os.path.join(ROOT_DIR, "warehouses", "warehouse_big_market"))
    main(os.path.join(ROOT_DIR, "warehouses", "warehouse_big_family"))
